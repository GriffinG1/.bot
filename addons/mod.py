...
class Moderation:
    ...
    def __init__(self, bot):
        self.bot = bot
        with open('cogs/warns.json', 'w+') as f:
    ...
    async def warn(self, ctx, member, *, reason):
        ...
        if not found_member:
            ...
            with open("cogs/warns.json") as f:
    ...
    async def listwarns(self, ctx, *, member):
        ...
        if not found_member:
            ...
            try:
                ...
                if user_warns:
                    embed = discord.Embed(title="Warns for user {}#{}".format(found_member.name, found_member.discriminator))
